                        ...
                        <div id="about-me" class="tab-pane fade active show">
                            <div class="profile-about-me">
                                <div class="pt-4 border-bottom-1 pb-3">
                                    ...
                                    <p class="mb-2">{{ Auth::user()->company->description }}</p>
                                </div>
                            </div>
                            <div class="profile-personal-info">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->commercial_name)}}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                    ...
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->company_name)}}</span>
                                    </div>
                                </div>                                                    
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                    ...
                                    <div class="col-sm-9 col-7"><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a9ccd1c8c4d9c5cce9ccd1c8c4d9c5ccc587cac6c4">{{Str::ucfirst(Auth::user()->company->email)}}</a></span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                    ...
                                    <div class="col-sm-9 col-7"><span>{{ Auth::user()->company->phone }}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                    ...
                                    <div class="col-sm-9 col-7">
                                        <span>{{ Auth::user()->company->country }}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                    ...
                                    <div class="col-sm-9 col-7"><span>{{ Str::ucfirst(Auth::user()->company->city) }}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                    ...
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->address)}}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                        <h5 class="f-w-500">Patente <span class="pull-right">:</span></h5>
                                    </div>
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->patente)}}</span>
                                    </div>
                                </div>        
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                        <h5 class="f-w-500">RC <span class="pull-right">:</span></h5>
                                    </div>
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->registre_commerce)}}</span>
                                    </div>
                                </div>        
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                        <h5 class="f-w-500">ID Fiscal <span class="pull-right">:</span></h5>
                                    </div>
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->identifiant_fiscal)}}</span>
                                    </div>
                                </div>        
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                        <h5 class="f-w-500">ICE <span class="pull-right">:</span></h5>
                                    </div>
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->ice)}}</span>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-3 col-5">
                                        <h5 class="f-w-500">CNSS <span class="pull-right">:</span></h5>
                                    </div>
                                    <div class="col-sm-9 col-7"><span>{{Str::ucfirst(Auth::user()->company->cnss)}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
